...
- **DO** use live web search to validate findings when local knowledge is insufficient, the code is sensitive or complex, or you want to verify API contracts, security advisories, CVE databases, or framework-specific security patterns.
