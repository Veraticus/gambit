...
- **DO** use live web search to validate findings when local knowledge is insufficient, the code is sensitive or complex, or you want to verify algorithmic complexity, database query behavior, or framework performance characteristics.
